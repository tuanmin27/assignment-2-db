-- SETUP
CREATE DATABASE ECommerceDB_Final_Part1;
...
-- 8 & 9. COUPON / FREESHIP
INSERT INTO COUPON (Voucher_ID) VALUES (1), (3), (5);
INSERT INTO FREESHIP (Voucher_ID) VALUES (2), (4);
...
(1, 1, 1), (1, 4, 2), (2, 2, 3), (3, 5, 1), (4, 3, 2);

-- 16. PAYMENT_METHOD
INSERT INTO PAYMENT_METHOD (Order_ID, Payment_type) VALUES
(1, 'BANKING'), (2, 'COD'), (3, 'COD'), (4, 'BANKING');

-- 17 & 18. COD / BANKING
INSERT INTO BANKING (Order_ID, Bank_name, Account_number) VALUES
(1, 'VCB', '1234567890'), (4, 'ACB', '0987654321');
INSERT INTO COD (Order_ID) VALUES (2), (3);
